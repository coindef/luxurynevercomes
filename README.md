...
墨黑 `#121110` + 香槟金 `#C8A96E` + 象牙白衬线；价格用 Didot 体全位数千分位展开——
**逗号的长度本身就是多巴胺**。动效原则"昂贵地慢"：600ms 慢淡入、CTA 上缓慢流过的金光、
无一处弹跳。与姊妹站共享的品牌真心：**治愈绿**（省钱/安抚侧）完整保留——
金色是橱窗，绿色是真心。完整设计文档见 [DESIGN.md](DESIGN.md)。
