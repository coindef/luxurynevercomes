  ...
  bracelet: [
    ...
    },
    {
      ...
      choices: [
        ...
        { name: 'Rigid, unopening · once on, it stays; a promise with no hinge', surcharge: 68000 },
      ],
    },
  ...
  bag: [
    ...
    },
    {
      ...
      choices: [
        ...
        { name: '35 · holds a laptop, and the laptop holds the work', surcharge: 18000 },
        { name: '40 · travel size, for the travel', surcharge: 38000 },
      ],
    },
  ...
  gown: [
    ...
    },
    {
      ...
      choices: [
        ...
        { name: 'Cut for when you slim down · optimism surcharge', surcharge: 88000 },
        { name: 'Cut generous · this is fine as it is; self-acceptance surcharge', surcharge: 88000 },
      ],
    },
  ...
  outerwear: [
    ...
    },
    {
      ...
      choices: [
        ...
        { name: 'To mid-calf · dramatic on a staircase', surcharge: 18000 },
        { name: 'To the ankle · sweeps the floor of a room you do not own yet', surcharge: 38000 },
      ],
    },
  ...
  shoes: [
    ...
    },
    {
      ...
      choices: [
        ...
        { name: 'One of each foot, measured separately · they are not the same size, they never were', surcharge: 68000 },
      ],
    },
  ...
  accessory: [
    ...
    },
    {
      ...
      choices: [
        ...
        { name: 'Made to your measurements · we will ask for three numbers and use one', surcharge: 28000 },
        { name: 'Oversized · deliberately too big, which reads as confidence', surcharge: 18000 },
      ],
    },
  ...
  wine: [
    {
      ...
      choices: [
        ...
        { name: 'Magnum, 1.5L · ages slower, in step with this shop', surcharge: 68000 },
        { name: 'Jeroboam, 3L · needs an occasion and two people to pour it', surcharge: 180000 },
        { name: 'Imperial, 6L · ages so slowly it will outlast the argument about opening it', surcharge: 480000 },
      ],
    },
    {
